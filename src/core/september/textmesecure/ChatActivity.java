 ...
 */
public class ChatActivity extends O9BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        me.setId(extras.getInt(Config.MY_ID));
        me.setLogin(extras.getString(Config.MY_LOGIN));
        me.setPassword(extras.getString(Config.MY_PASSWORD));

        QBUser friend = new QBUser();
        friend.setId(extras.getInt(Config.FRIEND_ID));
        friend.setLogin(extras.getString(Config.FRIEND_LOGIN));
        friend.setPassword(extras.getString(Config.FRIEND_PASSWORD));
        ...
        if (me != null && friend != null) {
           ...
           // myChatController.setOnMessageReceivedListener(onMessageReceivedListener);
            ...
            imService.startChat(friendLogin);
        }
    }
    ...
    private void sendMessage() {
        if (messageText != null) {
            ...
            imService.sendMessage(messageString);
            messageText.setText("");
