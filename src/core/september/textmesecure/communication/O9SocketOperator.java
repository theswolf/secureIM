...
public class O9SocketOperator implements ISocketOperator
{
	...
	private class ReceiveConnection extends Thread {
		...
		public ReceiveConnection(Socket socket) 
		{
			...
			O9SocketOperator.this.sockets.put(socket.getInetAddress(), socket);
		}
				...
				String inputLine;
				 ...
				 while ((inputLine = in.readLine()) != null) 
				 {
					 ...
					 else
					 {
						 ...
						 clientSocket.close();
						 O9SocketOperator.this.sockets.remove(clientSocket.getInetAddress());
					 }						 
				 }		
	...
	public O9SocketOperator(IAppManager appManager) {
